...
export default function Home() {
  return (
    <main className="flex h-screen flex-col items-center justify-between p-24  z-20 overflow-hidden">
      <div className="bg-[url('/background.jpg')] absolute top-0 bottom-0 w-full bg-cover z-0" />
