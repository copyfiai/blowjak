...
export default function Home() {
  return (
    <main className="flex h-screen flex-col items-center justify-between p-24  z-20">
      <div className="bg-[url('/background.jpg')] h-screen absolute top-0 min-h-screen w-full bg-cover z-0" />
      <div className=" bg-[#f06a22] opacity-90 absolute top-0 left-0 right-0 bottom-0" />
